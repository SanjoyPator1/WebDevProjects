  ...
  return (
    <>
      <div className="container relative min-h-screen flex-col items-center justify-center grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div className="absolute right-20 top-4 md:right-24 md:top-9">
          <ThemeSelector />
        </div>
        <Link
        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-input dark:border-r lg:flex">
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;Social media connects us like never before, bridging
                distances and uniting hearts across the globe. Embrace the power
                of connection and be part of the vibrant community shaping our
                digital world.&rdquo;
              </p>
